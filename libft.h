...
void	ft_memcpy_opti_af(void *dest,
			const void *src,
			size_t n);
...
int		print_hexa(unsigned int dec,
			int upper);

int		count_chars(unsigned long long dec,
			int b_len);

void	print_positive_base(unsigned long long dec,
			char *base,
			int b_len);
